      ...
      <div className="container py-12 lg:py-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-base text-secondary-300 max-w-md">
              Leading the way in AI governance, policy development, and ethical AI practices. 
              Building a safer, more transparent future for artificial intelligence.
            </p>
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.main.map((item) => (
                    <li key={item.name}>
                      <Link
                        href={item.href}
                        className="text-base text-secondary-300 hover:text-white transition-colors"
                      >
                        {item.name}
                      </Link>
                    </li>
            ...
            <div className="md:grid md:grid-cols-1 md:gap-8">
              <div>
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="text-base text-secondary-300">
                    <p>info@ai-regulation-association.org</p>
                    <p>+1 (555) 123-4567</p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-12 border-t border-secondary-700 pt-8">
          <p className="text-base text-secondary-400 text-center">
            &copy; {new Date().getFullYear()} AI Regulation Association. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
